...
public class GoSmartComputerPlayer extends GameComputerPlayer {
	...
	/**
	 * instance variable that tells which color of stone am I playing
     * (BLACK or white). This is set once the player finds out which
     * player they are, in the 'initAfterReady' method.
	 */
...
/*	protected void initAfterReady() {
	...
	protected void receiveInfo(GameInfo info) {
		...
		GoGameState myState = (GoGameState)info;

		// if it's not our move, ignore it
		if (myState.getPlayer() != this.playerNum) return;
