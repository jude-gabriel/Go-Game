...
/*
 *
 * ERRORS WITH SMARTEST AI-------
 *
 * After spending ~30hrs trying to implement the alpha-beta pruning algorithm,
 * we decided to go with Jude's dumber AI instead. I would have happily completed
 * this algorithm but given the complexity of both the algorithm and
 * non-determinism in Go, the time constraints were insufficient. :-(
 *
